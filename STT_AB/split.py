...
if __name__ == "__main__":
    stt_files = [filename for filename in os.listdir("full_audio") if filename.startswith("STT_AB") and os.path.isfile(os.path.join("full_audio", filename))]
    print(stt_files)
    if not os.path.exists("after_split"):
        os.makedirs("after_split")
